...
@section('title', 'Nueva Cuota de Colegiatura')
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            ...
            <section class="content-header">
                <h1>
                    Crear nueva cuota de colegiatura
                    <small></small>
                </h1>
            </section>
                        ...
                        <form class="form-horizontal" method="post" action="" name="form_cuotacolegiatura" id="form_cuotacolegiatura">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" id="cicloescolar" name="cicloescolar" value="{{$ciclo->ciclo_anioinicial}}-{{$ciclo->ciclo_aniofinal}}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="cuotacolegiatura_nombre" name="cuotacolegiatura_nombre" placeholder="Nombre para identificar a la cuota de colegiatura">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" id="cuotacolegiatura_cuota" name="cuotacolegiatura_cuota">
                                    </div>
                                </div>
            ...
            $("#boton_enviar").click(function(){
                ...
                else if(cuota.length === 0)
                {
                    ...
                    $("#form_cuotacolegiatura").validate({
                        ...
                        messages:{
                            cuotacolegiatura_nombre : 'Falta el nombre de la cuota a crear',
