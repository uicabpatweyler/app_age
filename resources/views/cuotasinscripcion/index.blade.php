...
@section('title', 'Cuotas de Inscripción')
            ...
            <div class="col-md-12">
                ...
                <div class="box box-success">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">Cuotas de Inscripción: {{$ciclo->ciclo_anioinicial}}-{{$ciclo->ciclo_aniofinal}}</h3>
                    </div>
                    <!-- /.box-header -->
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <a class="btn btn-success form-control" href="{{route('nueva_cdi')}}">
