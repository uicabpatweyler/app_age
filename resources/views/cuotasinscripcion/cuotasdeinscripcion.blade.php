...
@section('title', 'Lista de Cuotas de Inscripción')
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-header with-border">
                            ...
                            <small>&nbsp;&nbsp;(Cuotas de inscripción de la escuela elegida)</small>
                        </div>
                        <!-- /.box-header -->
                            ...
                            <table class="table table-striped" id="clasificaciones">
                                ...
                                @foreach($cuotas as $cuota)
                                    <tr>
                                        ...
                                        <td>{{$cuota->cuotainscripcion_nombre}}</td>
                                        <td>$ {{number_format($cuota->cuotainscripcion_cuota, 2, '.', ',')}}</td>
                                        <td>
    ...
    <script>
        $(document).ready(function(){
            ...
            $(".btn-danger").click(function () {
                //Columna 1 = ID de la cuota de inscripcion. Columna no visible
                var id_cdi = $(this).parents("tr").find("td")[1].innerHTML;

                swal({
                    title: '¿Esta seguro de querer eliminar la cuota de inscripción elegida?',
                    text: "",
                    type: 'warning',
