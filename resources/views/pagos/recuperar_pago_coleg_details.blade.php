...
@section('title', 'Recuperar Recibo de Pago de Colegiatura')
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            ...
            <section class="content-header">
                <h1>Recuperar Recibo de Pago de Colegiatura</h1>
            </section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">Detalles del recibo de pago de colegiatura</h3>
                        </div>
                        <!-- /.box-header -->
...
@section('scripts')
    <script>
        $(document).ready(function(){
            moment.locale('es');
            $('#fecha_cancelacion').val(moment('{{$pagoColegiatura->fecha_cancelacion->format('Y-m-d')}}', 'YYYY-MM-DD').format('DD-MMMM-YYYY'));

            $("#boton_guardar").click(function(){
                swal({
                    title: 'Confirmar acción',
                    html: '¿Desea realmente recuperar el recibo de pago #: <strong>'+ $('#folio_recibo').val()  + '</strong>?',
                    type: "warning",
            ...
            function ajaxSubmitForm(){
                $.ajax({
                    type:"POST",
                    url:"{{route('recuperar_pago_colegiatura')}}",
