...
@section('title', 'Pago de Colegiatura - Elegir Alumno')
                            ...
                            @foreach($dias as $dia)
                                <tr>
                                    ...
                                    <td style="width: 20%;" align="center">
                                        ...
                                        <a class="btn btn-xs btn-social btn-dropbox" href="{{route('pago_colegiatura_create',['escuela'=>$dia->escuela_id,'ciclo'=>$ciclo->id,'grupo'=>$dia->grupo_id,'alumno'=>$dia->alumno_id])}}">
                                            <i class="fa fa-pencil-square-o" aria-hidden="true"></i> Elegir Alumno
                                        </a>
