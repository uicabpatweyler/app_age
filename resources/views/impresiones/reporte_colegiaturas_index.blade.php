            ...
            <div class="col-md-12">
                ...
                <div class="box box-success">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">Reporte de Pagos de Colegiatura <small>Los campos marcados con (*) son obligatorios</small></h3>
                    </div>
                    <!-- /.box-header -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-6">
                                                <button class="btn  btn-social btn-dropbox pull-right" id="btn_generar_reporte" enabled>
...
$(document).ready(function(){
    ...
    $('#btn_buscar').click( function() {
        ...
        if ( $.fn.dataTable.isDataTable( '#dt_resumen_reporte' ) ) {
            ...
            dt_resumen_reporte = $('#dt_resumen_reporte').DataTable({
                "ajax": urlRoot+'/pagos_colegitura_por_dia/'+fecha_reporte,
                "paging": false,
                "destroy": true,
                "lengthChange": false,
                "searching": false,
    ...
    $('#btn_generar_reporte').click( function() {
        if ( ! $('#dt_resumen_reporte').dataTable().api().data().any() ) {
            ...
            window.open(urlRoot+'/pdf_ReporteDiarioColegiatura/'+fecha_reporte, '_blank');
            return false;
        }
    });
