...
class Escuela extends Model
{
    ...
    //Relacion 1:M. Lado 1
    //Una ESCUELA se usa para crear 1 o MUCHAS CUOTAS DE INSCRIPCION
    public function CuotasDeInscripcion(){
        return $this->hasMany(CuotaInscripcion::class);
    }

    //Relacion 080818_0155: Lado 1
    //Una ESCUELA se usa UNA o MUCHAS veces en la entidad DATOS_INSCRIPCION_ALUMNO
