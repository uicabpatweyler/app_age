...
class ImprReciboInscripcionController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $pagosDeInscripcion = PagoInscripcion::where('escuela_id',1)
                              ->where('ciclo_id',$ciclo->id)
                              ->orderBy('folio_recibo', 'asc')
                              ->get();
        
        return view('impresiones.impr_rec_inscrip_index', compact('ciclo','pagosDeInscripcion'));
    }
